...
public class JsonRepositoryPopulator {

    private JsonExtractor sourceDataExtractor;
    private JsonExtractor metadataExtractor;
    public JsonRepositoryPopulator(JsonExtractor sourceExtractor, JsonExtractor metadataExtractor){
        this.sourceDataExtractor = sourceExtractor;
